...
def test_summarise_actions_buckets_file_edits_and_writes():
    tool_uses = [
        ...
        {"name": "Read", "input": {"file_path": "/Users/me/repo/bar.py"}},
        {
            "name": "Edit",
            "input": {
                "file_path": "/Users/me/Documents/GitHub/proj/x.py",
                "old_string": "a",
                "new_string": "b",
            },
        },
        {
            "name": "Write",
            "input": {"file_path": "/Users/me/Documents/GitHub/proj/y.py", "content": "..."},
        },
...
def test_summarise_actions_truncates_long_read_lists():
    tool_uses = [{"name": "Read", "input": {"file_path": f"/r/file{i}.py"}} for i in range(25)]
    out = _summarise_actions(tool_uses)
...
def test_summarise_final_todos_takes_last_call_only():
    ...
    tool_uses = [
        {
            "name": "TodoWrite",
            "input": {"todos": [{"content": "old", "status": "pending", "activeForm": ""}]},
        },
        {
            "name": "TodoWrite",
            "input": {"todos": [{"content": "current", "status": "in_progress", "activeForm": ""}]},
        },
    ]
    out = _summarise_final_todos(tool_uses)
                    ...
                    "message": {
                        ...
                        "content": [
                            {"type": "text", "text": "I'll add feature X."},
                            {
                                "type": "tool_use",
                                "name": "Write",
                                "input": {"file_path": "/r/x.py", "content": "..."},
                            },
                            {
                                "type": "tool_use",
                                "name": "TodoWrite",
